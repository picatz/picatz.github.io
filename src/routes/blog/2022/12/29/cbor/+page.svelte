...
<BlogPost>
    <BlogHeader title={metadata.title} date="12-29-2022">
        <a href="https://www.rfc-editor.org/rfc/rfc8949.html" class="text-blue-500">Concise Binary Object Representation </a> (<strong>CBOR</strong>)
        is a data format designed to be concise and extensible. It is used by <a href="https://www.w3.org/TR/webauthn" class="text-blue-500"><strong>WebAuthn</strong></a> (<a href="https://fidoalliance.org/specs/fido-v2.0-id-20180227/fido-client-to-authenticator-protocol-v2.0-id-20180227.html#message-encoding" class="text-blue-500">CTAP2</a>),
    ...
    <div class="mt-6">
        ...
        <Table headers={['Name', 'Tag Number']} rows={[
            ['Date Time (String)', '0'],
            ['Date Time (Epoch)', '1'],
            ['Positive Bignum', '2'],
            ['Negative Bignum', '3'],
        ...
        <Panel>
            This is not an exhaustive list of all the tags. IANA maintains a <a href="https://www.iana.org/assignments/cbor-tags/cbor-tags.xhtml" class="text-blue-500">registry</a> of tags you can refer to.
        </Panel>

        <br>

        <p>
            CBOR is similar to otherformats such as <Link url="https://www.json.org/json-en.html">JSON</Link>, <Link url="https://bsonspec.org/">BSON</Link>, 
            <Link url="https://msgpack.org/index.html">MessagePack</Link>, or <Link url="https://developers.google.com/protocol-buffers">Protcol Buffers</Link>. The following table shows the
            encoded bytes for a simple message in each format.
        </p>
        
        <br>

        <Table headers={['Format', 'Bytes', 'Size']} rows={[
            ['JSON', {value: '{"hello":"world"}', code: true}, 17],
            ['BSON', {value: '\\x16\\x00\\x00\\x00\\x02hello\\x00\\x06\\x00\\x00\\x00world\\x00\\x00', code: true}, 22],
        ...
        <p>
            ...
            most similar to MessagePack, which it actually <a href="https://www.rfc-editor.org/rfc/rfc7049#section-9">took inspiration from</a>.
            
            Unlike the rest of the examples shown, Protcol Buffers is <i>not</i> a schemaless format. It requires a schema to be defined, which 
            is then used to encode and decode the data. This is why it can ommit the field name "<code>hello</code>" and just reference it by 
            a field number (<code>\x0a</code>).
        </p>
        ...
        <Code>
            <span class="text-indigo-200">\x9f\x7f<span class="text-red-500">\x61\x61\xff</span>...\xff</span>
        </Code>
        ...
        <div class="bg-gray-200 p-2 rounded-lg">
            ...
            one for each string in the array, and one more to terminate the array.
            </p>   
        </div>
        ...
        <p>
            Depending on the decoder implementation, and network transport, an infinite amount of <code>\x61\x61</code> could be sent by the attacker. 
        </p>
        ...
        <div class="flex flex-wrap items-center justify-center">
            <div class="w-2/5">
                <div class="bg-white rounded-lg p-4">
                    ...
                    <div class="bg-gray-800 rounded-lg p-4">
                        <p class="text-center overflow-hidden"><code>
                            <span class="text-indigo-200">\x9f\x7f<span class="text-red-500">\x61\x61\xff</span>...</span>
                        </code></p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-1/5 flex items-center justify-center mt-4">
                ...
                <p id="stream" class="text-center text-red-500 overflow-hidden"><code>\x61\x61\xff</code></p>
            ...
            <div class="w-2/5">
                <div class="bg-white rounded-lg p-4">
                    ...
                    <div class="bg-gradient-to-r from-gray-200 to-gray-400 rounded-lg p-4">
                        <p id="memory" class="text-center overflow-hidden"><code>
                            Array[<span class="text-red-500">"a"</span>, <span class="text-red-500">"a"</span>, <span class="text-red-500">"a"</span>, <span class="text-red-500">...</span>]
                        </code></p>
                    </div>
                </div>
            </div>
        ...
        <p>
            This attacks would be very cheap for an attacker to send, and would balloon the memory usage of the decoder on the server.
        </p>
        
        <br>

        <Panel icon="fa-lightbulb" color="bg-amber-300" iconColor="text-amber-500" ring="ring-2" ringColor="ring-amber-500">
            Variations of this attack exist in each of the other codecs. This is not solely a CBOR problem.
        </Panel>
        
        <br>

        <p>
            There are a number of ways to mitigate these kinds of attacks, such as limiting the size of the data being decoded,
            limiting the depth of the data structure, or restricting the types allowed in the data structure (generally do not 
            allow infinite maps and arrays).
        </p>
        ...
        <p>
            ...
            the number of requests that can be sent by a single client in a given time period. While you're at it, add idle/read/write timeouts to mitigate
            <Link url="https://en.wikipedia.org/wiki/Slowloris_(computer_security)">slow-loris</Link>-like  attacks. 
        </p>
        
        <br>
            
        <p>
            <Link url="https://en.wikipedia.org/wiki/Mutual_authentication#mTLS">mTLS</Link> can also be used to 
            ensure that only trusted clients are able to connect to the server.  
        </p>
        
        <br>
            
        <p>
            Doing any these in combination enables <a href="https://en.wikipedia.org/wiki/Defense_in_depth_(computing)">defense in depth</a>.
        </p>
        <br>
    </div>
</BlogPost> 